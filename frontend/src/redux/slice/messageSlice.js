...
import { ItemRomoved, disableUser, invalidEmail, logUser, orderPlaced, orderUpdate, passwordDoNotMatch, productAdd, saveAnAddress, serverError, userAlreadyExist, userDisabled, userEnabled, userNotFound, wrongPassword } from "../../data/constants";
        ...
        setMessage: (state, action) => {
            switch (action.payload) {
                ...
                case wrongPassword: case userNotFound: state.message = { message: action.payload, severity: "error" }
                    break;
                case userAlreadyExist:case passwordDoNotMatch:case invalidEmail:case ItemRomoved: state.message = { message: action.payload, severity: "info" }
                    break;
                ...
                case orderPlaced: state.message = { message: "Order Placed Sucessfully", severity: "success" }
                    break;
                case orderUpdate: state.message = { message: "Successfully Updated", severity: "success" }
                    break;
                default:
